...
//        NSString *fullNamespace = [@"com.hackemist.SDWebImageCache." stringByAppendingString:ns];
        ...
        NSString *fullNamespace=@"Documents/resource/PermanentStore";
...
//        _diskCachePath = [paths[0] stringByAppendingPathComponent:fullNamespace];
        ...
        _diskCachePath = [NSHomeDirectory() stringByAppendingPathComponent:fullNamespace];
        
        NSLog(@"SDWI缓存目录 %@",_diskCachePath);
...
- (NSString *)cachedFileNameForKey:(NSString *)key {
    ...
    return [mapping imagePathForKey:key];
}
    ...
    if (toDisk) {
        dispatch_async(self.ioQueue, ^{
            ...
            if (data) {
                ...
                //创建保存目录
                MappingRule *mapping=[[MappingRule alloc] init];
                BOOL isSuccess=[mapping createStoragePath:[self defaultCachePathForKey:key]];
                if (isSuccess) {
